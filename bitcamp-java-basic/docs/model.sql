...
CREATE TABLE lms_stud (
  ...
  scno  INTEGER     NOT NULL COMMENT '학교번호', -- 학교번호
  majno INTEGER     NOT NULL COMMENT '전공번호', -- 전공번호
  bammo INTEGER     NULL     COMMENT '은행번호', -- 은행번호
...
ALTER TABLE lms_school
  MODIFY COLUMN scno INTEGER NOT NULL AUTO_INCREMENT COMMENT '학교번호';
...
CREATE TABLE lms_bank (
  bammo INTEGER     NOT NULL COMMENT '은행번호', -- 은행번호
...
ALTER TABLE lms_bank
  MODIFY COLUMN bammo INTEGER NOT NULL AUTO_INCREMENT COMMENT '은행번호';
...
CREATE TABLE lms_room_photo (
  pno      INTEGER      NOT NULL COMMENT '교실사진번호', -- 교실사진번호
...
ALTER TABLE lms_room_photo
  MODIFY COLUMN pno INTEGER NOT NULL AUTO_INCREMENT COMMENT '교실사진번호';
