...
public class Exam0210 {
  public static void main(String[] args) throws Exception {
    ...
    // - this 라는 내장 변수를 가지고 있다.
    // - 특정 인스턴스의 변수를 다루는 메서드

    char c1 = s1.charAt(1);
    System.out.println(c1);
    // 'H','e','l','l','o' 인스턴스의 1번째 인스턴스를 호출
    ...
    // "ABC가각"
    // - Linux/Unix: 41 42 41 ea b0 80 ea b0 81
    ...
    System.out.println(cal.get(4)); // 해당 월의 몇 번째 주인지
    ...
    System.out.println(cal.get(Calendar.WEEK_OF_MONTH)); // 해당 월의 몇 번째 주인지
