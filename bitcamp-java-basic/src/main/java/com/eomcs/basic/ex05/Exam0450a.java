...
public class Exam0450a {
  public static void main(String[] args) {
    // yes or no 또는 true or false 값을 저장할 때
    // 비트 연산자를 사용하여 메모리를 절약할 수 있다.
    ...
    // 배열도 이용이 가능하다.
    //boolean 배열은 기본적으로 자바에서 1바이트를 사용한다.
    //따라서 boolean 배열시 8개의 데이터는 8바이트가 소요된다.
    ...
    // 비트 연산자를 사용하면 4바이트 변수 한개로 32개 데이터
    // 저장이 가능하다
    int lang2 = 0;
